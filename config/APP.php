<?php
	...
	----------*/
	const SERVERURL="http://localhost/mamaq/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="Mamá Qucha";
	...
	const FACEBOOK="https://www.facebook.com/mamaquchasublimacion?mibextid=ZbWKwL";
	const INSTAGRAM="https://www.instagram.com/mamaquchaestampados/";
	const YOUTUBE="";
	const TWITTER="";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Santa Fe";
	const ADDRESS="Santa Fe, Argentina";
